...
cccccccc:ccccccccccco:;,;:ccccccccccccccccccc
cccc;:c;'::;cccccccc0c...'ccccccccccccccccccc
cccc,cc;.:c,;ccccloOd.....,cccccccccccccccccc
ccc'cc'..':c,;cccll,.......;ccccccccccccccccc
cc:.c;'..':c,,cc'...........:cccccccccccccccc
ccc:'......',ccc:...........,cccccccccccccccc
cccc:'....'cccccl;...........;ccccclcccccllll
lllllc'...:lllllc'............cllllllllllllll
lllllc....,:cc;'..............',;clllllllllll
lllllc''..........................:llllllllll
lllllc,:',''......................'llllllllll
llllll':'::lc::;...................:lllllllll
lllllc,;':;llll:.,.................'lllllllll
lllllc,;'c,llll:';'............:'...;llllllll
llllll,,'c,llllc;;,............,c....:lllllll
cclccc','c'lllll:;..............;;...'ccccccc
cccccc'.'c.lllll::...............;....ccccccc
...
def banner():
	print(fontcolor.green(banr))

class num:
	one = fontcolor.red("[1] ")
	two = fontcolor.red("[2] ")
	three = fontcolor.red("[3] ")
	four = fontcolor.red("[4] ")
	five = fontcolor.red("[5] ")
	six = fontcolor.red("[6] ")
	seven = fontcolor.red("[7] ")

def border_msg(msg):
    row = len(msg)
    m = ''.join(['        +'] + ['-' *row] + ['+'])
    h = fontcolor.green(m)
    result= h + '\n' + fontcolor.green("        |") + fontcolor.white(msg) + fontcolor.green("|") + '\n' + h
    print((result))

choice_one = fontcolor.yellow("Add New Student")
choice_two = fontcolor.yellow("View Students")
choice_three = fontcolor.yellow("Search Student")
choice_four = fontcolor.yellow("Update Student")
choice_five = fontcolor.yellow("Delete Student")
choice_six = fontcolor.yellow("Project MADE BY")
choice_seven = fontcolor.yellow("Quit")

#choice menu 
def display_menu():
	banner()
	border_msg(" Welcome To Student Management System ! ")
...
def continue_msg():
	input("\n" + smb.ARROW + fontcolor.green("Press Enter To Continue : "))
	clr_scr()
...
def about_us():
	print("\n")
	border_msg(" Project Made By ")
	#print("\n")
	z = PrettyTable()
	field_1 = fontcolor.green("CreatoR")
	field_2 = fontcolor.green("Gurudev")
	field_3 = fontcolor.green("Aim")
	z.field_names = [field_1,field_2,field_3]
	
	z.add_row(['Mahadev Fan', 'Mahakal','2'])
	z.add_row(['Mahadev Fan', 'Mahakal','2'])
	z.add_row(['Mahadev Fan', 'Mahakal','2'])
	z.add_row(['Mahadev Fan', 'Mahakal','2'])
